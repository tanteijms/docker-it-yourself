...
import org.apache.commons.codec.digest.DigestUtils as ApacheDigestUtils;
...
public class DigestUtils {
    ...
    public static String calculateSHA256(String content) {
        return SHA256_PREFIX + ApacheDigestUtils.sha256Hex(content.getBytes(StandardCharsets.UTF_8));
    }
    ...
    public static String calculateSHA256(byte[] bytes) {
        return SHA256_PREFIX + ApacheDigestUtils.sha256Hex(bytes);
    }
    ...
    public static String calculateSHA256(InputStream inputStream) throws IOException {
        return SHA256_PREFIX + ApacheDigestUtils.sha256Hex(inputStream);
    }
